...
@{
    ...
    InstalledModule =   - {0} module v{1} is currently installed.
    AvailableModule =     - {0} module v{1} update is available.
    UpdateModule =     - Run 'Update-Module -Name {0} -Force' to install the latest version.
    ...
    GettingForestInfo = - Getting {0} forest information.
    DiscoveringChildDomains =     - Discovering {0} forest child domains: {1}
    DCFound =     - Initial Setup: An available DC in {0} domain is found. Adding domain to the report.
    DCNotFound =     - Unable to get an available DC in {0} domain. Removing domain from the report.
    FinishingForestList =     - Finishing building {0} forest domains list: {1}
    WorkingOnForestSection = - Working on Forest section.
    WorkingOnDomainSection = - Working on Domain section.
    WorkingOnDNSSection = - Working on DNS section.
    WorkingOnPKISection = - Working on PKI section.
    ExportDiagramsEnabled = - ExportDiagrams option enabled: Exporting diagrams:
    FinishedReportGeneration = - Finished report generation for {0} forest:
    UnreachableSystems = The following Systems could not be reached:
    OfflineDCsHeader = Domain Controllers
    OfflineDomainHeader = Domains
'@

    # Get-AbrDNSSection
    GetAbrDNSSection = ConvertFrom-StringData @'
    CollectingDNS =   - Collecting DNS information from {0}.
'@
...
'@
    ...
    ExecutionTime = CA Authority Information Access Objects Section execution time: {0} Hours {1} Minutes {2} Seconds
'@

...
'@
    ...
    Collecting = Recopilando informacion del Controlador de Dominio de AD.
    HealthCheck = Verificacion de Salud:
    BestPractice = Mejor Practica:
    BestPractices = Mejores Practicas:
    CorrectiveActions = Acciones Correctivas:
    SecurityBestPractices = Mejores Practicas de Seguridad:
    DCName = Nombre del DC
    Status = Estado
    Online = En Linea
    Offline = Fuera de Linea
    Site = Sitio
    GlobalCatalog = Catalogo Global
    ReadOnly = Solo Lectura
    IPAddress = Direccion IP
    DomainControllerTableName = Controlador de Dominio en el Dominio
    DCBestPractice = Todos los dominios deben tener al menos dos controladores de dominio en funcionamiento para redundancia. En caso de fallo en el unico controlador de dominio del dominio, los usuarios no podran iniciar sesion ni acceder a los recursos del dominio. Esto garantiza alta disponibilidad y tolerancia a fallos dentro de la infraestructura del dominio.
    DomainControllerCount = Controlador de Dominio
    DomainControllerCountsTableName = Conteo de Controladores de Dominio
    GeneralInformationTitle = Informacion General
    DomainName = Nombre del Dominio
    OperationMasterRoles = Roles de Maestro de Operaciones
    Location = Ubicacion
    ComputerObjectSID = SID del Objeto de Computadora
    OperatingSystem = Sistema Operativo
    SMB1Status = Estado de SMB1
    Enabled = Habilitado
    Description = Descripcion
    GeneralInfoTableName = Informacion General
    SMB1BestPractice = Deshabilitar SMBv1: SMBv1 es un protocolo obsoleto que es vulnerable a varios problemas de seguridad. Se recomienda deshabilitar SMBv1 en todos los sistemas para mejorar la seguridad y reducir el riesgo de explotacion. SMB v1 ha sido reemplazado por SMB v2 y SMB v3, que ofrecen mejor rendimiento y funciones de seguridad.
    PartitionsTitle = Particiones
    DefaultPartition = Particion Predeterminada
    Partitions = Particiones
    PartitionsTableName = Particiones
    NetworkingTitle = Configuracion de Red
    IPv4Addresses = Direcciones IPv4
    IPv6Addresses = Direcciones IPv6
    LDAPPort = Puerto LDAP
    LDAPSPort = Puerto LDAPS
    NetworkingTableName = Configuracion de Red
    NetworkingBestPractice = En los Controladores de Dominio con mas de una NIC donde cada NIC esta conectada a una red separada, existe la posibilidad de que el registro DNS del Host A ocurra para NICs no deseadas. Evite registrar NICs no deseadas en DNS en un controlador de dominio multihomed.
    HardwareInventoryTitle = Inventario de Hardware
    Name = Nombre
    WindowsProductName = Nombre del Producto Windows
    WindowsBuildNumber = Numero de Compilacion de Windows
    ADDomain = Dominio AD
    WindowsInstallDate = Fecha de Instalacion de Windows
    ...
    NumberOfProcessors = Numero de Procesadores
    NumberOfCPUCores = Numero de Nucleos de CPU
    NumberOfLogicalCores = Numero de Nucleos Logicos
    PhysicalMemory = Memoria Fisica
    HardwareInventoryTableName = Inventario de Hardware
    HWBestPractice = Microsoft recomienda tener suficiente RAM (8GB+) para cargar todo el DIT en memoria, ademas de acomodar el sistema operativo y otras aplicaciones instaladas, como antivirus, software de respaldo, monitoreo, etc. La memoria insuficiente puede provocar problemas de rendimiento y tiempos de respuesta lentos, lo que puede afectar la salud y eficiencia general del controlador de dominio.
    ConfigurationTitle = Configuracion
    DNSIPConfigTitle = Configuracion de IP DNS
    Interface = Interfaz
    PreferedDNS = DNS Preferido
    AlternateDNS = DNS Alternativo
    DNS3 = DNS 3
    DNS4 = DNS 4
    DNSIPConfigTableName = Configuracion de IP DNS
    DNSIPConfigBP1 = La configuracion DNS en el adaptador de red debe incluir la direccion de loopback (127.0.0.1) pero no debe ser la primera entrada.
    DNSIPConfigBP2 = La configuracion DNS en el adaptador de red no debe incluir la propia direccion IP del Controlador de Dominio como primera entrada.
    DNSIPConfigBP3 = Por razones de redundancia, la configuracion DNS en el adaptador de red debe incluir una direccion DNS alternativa. Esto garantiza que si el servidor DNS primario no esta disponible, el sistema aun pueda resolver nombres de dominio usando el servidor DNS alternativo.
    DNSIPConfigCA = Las interfaces de red deben estar configuradas con servidores DNS que puedan resolver nombres en el dominio raiz del bosque. El siguiente servidor DNS no respondio a la consulta del dominio raiz del bosque {0}: {1}
    NTDSTitle = Informacion de NTDS
    ...
    NTDSTableName = Uso del Archivo de Base de Datos NTDS
    TimeSourceTitle = Informacion de Fuente de Tiempo
    TimeServer = Servidor de Tiempo
    Type = Tipo
    DomainHierarchy = Jerarquia de Dominio
    ManualNTP = MANUAL (NTP)
    DOMHIER = DOMHIER
    TimeSourceTableName = Configuracion de Fuente de Tiempo
    ...
    SRVBestPractice = El registro SRV es un registro de recursos del Sistema de Nombres de Dominio (DNS). Se utiliza para identificar computadoras que alojan servicios especificos. Los registros de recursos SRV se utilizan para localizar controladores de dominio para Active Directory. Estos registros son esenciales para el correcto funcionamiento de Active Directory.
    FileSharesTitle = Recursos Compartidos
    Path = Ruta
    FileSharesTableName = Recursos Compartidos
    FileSharesParagraph = Los siguientes Controladores de Dominio contienen recursos compartidos no predeterminados mas alla de los recursos administrativos estandar, NETLOGON y SYSVOL:
    FileSharesBestPractice = Solo los recursos compartidos de netlogon, sysvol y los predeterminados de administracion deben existir en un Controlador de Dominio. Si es posible, los recursos compartidos no predeterminados deben moverse a otro servidor, preferiblemente un servidor de archivos dedicado.
    InstalledSoftwareTitle = Software Instalado
    Publisher = Editor
    InstallDate = Fecha de Instalacion
    InstalledSoftwareTableName = Software Instalado
    InstalledSoftwareParagraph = Esta seccion proporciona una descripcion general de las instalaciones de software de terceros y no predeterminadas detectadas en los Controladores de Dominio dentro del dominio {0}.
    InstalledSoftwareBestPractices = No ejecute otro software o servicios en un Controlador de Dominio. Ejecutar software o servicios adicionales en un Controlador de Dominio puede introducir vulnerabilidades de seguridad, aumentar la superficie de ataque y potencialmente degradar el rendimiento de los servicios de dominio criticos.
    MissingUpdatesTitle = Actualizaciones de Windows Pendientes
    KBArticle = Articulo KB

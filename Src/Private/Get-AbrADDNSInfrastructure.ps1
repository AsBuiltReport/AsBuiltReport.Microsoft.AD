function Get-AbrADDNSInfrastructure {
    ...
    process {
        ...
        Section -Style Heading4 "Domain Name System Forwarder Summary" {
        ...
        Section -Style Heading4 "Domain Name System Scavenging Summary" {
        ...
        Section -Style Heading4 "Domain Name System Zone Scope Recursion Summary" {

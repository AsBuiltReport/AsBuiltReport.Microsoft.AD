                ...
                Section -Style Heading3 "$($DC.ToString().ToUpper().Split(".")[0]) DNS Zones" {
                                ...
                                foreach ($Zone in $DNSSetting) {
                                    try {
                                        ...
                                        if ($Delegations) {
                                            ...
                                            Write-PscriboMessage -IsWarning "No Zone Delegation information found, disabling section."
                                        }
                                    }
                                    catch {
                    ...
                    if ($InfoLevel.DNS -ge 2) {
                        try {
                            ...
                            if ($DNSSetting) {
                                ...
                                Write-PscriboMessage -IsWarning "No Zone Transfer information found, disabling section."
                            }
                        }
                        catch {
                    ...
                    try {
                        ...
                        if ($DNSSetting) {
                            ...
                            Write-PscriboMessage -IsWarning "No Reverse lookup zone information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($DNSSetting) {
                            ...
                            Write-PscriboMessage -IsWarning "No Conditional forwarder zone information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    if ($InfoLevel.DNS -ge 2) {
                        try {
                            ...
                            if ($Zones) {
                                ...
                                Write-PscriboMessage -IsWarning "No Zone Aging property information found, disabling section."
                            }
                        }
                        catch {

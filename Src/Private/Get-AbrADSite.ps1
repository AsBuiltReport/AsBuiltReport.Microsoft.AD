                    ...
                    if ($Options.EnableDiagrams) {
                        try {
                            ...
                            if ($Graph) {
                                ...
                                Section -Style Heading4 'Replication Diagram' {
                                    Image -Base64 $Graph -Text 'Replication Diagram' -Width $BestAspectRatio.Width -Height $BestAspectRatio.Height -Align Center
                                }
                                BlankLine -Count 2
                            }
                        } catch {

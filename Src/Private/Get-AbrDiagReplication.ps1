                        ...
                        SubGraph MainSubGraph -Attributes @{Label = ' ' ; fontsize = 24; penwidth = 1.5; labelloc = 't'; style = $SubGraphDebug.style; color = $SubGraphDebug.color } {
                            ...
                            if ($Sites -and ($Sites | Measure-Object).Count -gt 0) {
                                ...
                                foreach ($Site in $Sites) {
                                    ...
                                    SubGraph $SiteNodeName -Attributes @{Label = (Add-DiaHtmlLabel -ImagesObj $Images -Label $Site -IconType 'AD_Site' -IconDebug $IconDebug -SubgraphLabel -IconWidth 35 -IconHeight 35 -Fontsize 18 -FontName 'Segoe UI' -FontColor $Fontcolor); fontsize = 18; penwidth = 1.5; labelloc = 't'; style = $SubGraphDebug.style; color = $SubGraphDebug.color } {
                                ...
                                if ($UnknownSiteDCs) {
                                    ...
                                    SubGraph $UnknownSiteNodeName -Attributes @{Label = (Add-DiaHtmlLabel -ImagesObj $Images -Label $reportTranslate.NewADDiagram.replUnknownSite -IconType 'AD_Site' -IconDebug $IconDebug -SubgraphLabel -IconWidth 35 -IconHeight 35 -Fontsize 18 -FontName 'Segoe UI' -FontColor $Fontcolor); fontsize = 18; penwidth = 1.5; labelloc = 't'; style = $SubGraphDebug.style; color = $SubGraphDebug.color } {
                            ...
                            foreach ($Repl in $ReplInfo) {
                                ...
                                if ($FromNodeName -and $ToNodeName -and $FromNodeName -ne $ToNodeName) {
                                    ...
                                    if (-not $DrawnEdges.Contains($EdgeKey)) {
                                        ...
                                        Edge -From $FromNodeName -To $ToNodeName @{minlen = 2; label = $EdgeLabel; fontsize = 14; fontname = 'Segoe UI' }
                                    }
                                }
                            }
                        }

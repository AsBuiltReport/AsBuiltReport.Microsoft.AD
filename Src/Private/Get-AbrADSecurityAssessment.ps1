        ...
        if ($HealthCheck.Domain.Security) {
            try {
                ...
                if ($DomainUsers) {
                    ...
                    Write-PscriboMessage -IsWarning "No Domain users information found, disabling section."
                }
            }
            catch {
                Write-PscriboMessage -IsWarning "$($_.Exception.Message) (Account Security Assessment Table)"
            ...
            if ($InfoLevel.Domain -ge 2) {
                try {
                    ...
                    if ($PrivilegedUsers) {
                        ...
                        Write-PscriboMessage -IsWarning "No Privileged User Assessment information found, disabling section."
                    }
                }
                catch {
                    Write-PscriboMessage -IsWarning "$($_.Exception.Message) (Account Security Assessment Table)"
                ...
                try {
                    ...
                    if ($InactivePrivilegedUsers) {
                        ...
                        Write-PscriboMessage -IsWarning "No Inactive Privileged Accounts information found, disabling section."
                    }
                }
                catch {
                    Write-PscriboMessage -IsWarning "$($_.Exception.Message) (Account Security Assessment Table)"
                ...
                try {
                    ...
                    if ($UserSPNs) {
                        ...
                        Write-PscriboMessage -IsWarning "No Service Accounts Assessment information found, disabling section."
                    }
                }
                catch {
                    Write-PscriboMessage -IsWarning "$($_.Exception.Message) (Account Security Assessment Table)"

                ...
                if ($GPOs) {
                    ...
                    if ($InfoLevel.Domain -ge 2) {
                        try {
                            ...
                            if ($WmiFilters) {
                                ...
                                Write-PscriboMessage -IsWarning "No WMI Filter information found, disabling section."
                            }
                        }
                        catch {
                            Write-PscriboMessage -IsWarning "$($_.Exception.Message) (WMI Filters)"
                    ...
                    try {
                        ...
                        if ($PATH) {
                            ...
                            Write-PscriboMessage -IsWarning "No GPO Central Store information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($OutObj) {
                            ...
                            Write-PscriboMessage -IsWarning "No GPO Logon/Logoff script information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($OutObj) {
                            ...
                            Write-PscriboMessage -IsWarning "No GPO Computer Startup/Shutdown script information found, disabling section."
                        }
                    }
                    catch {
                ...
                if ($HealthCheck.Domain.GPO) {
                    try {
                        ...
                        if ($OutObj) {
                            ...
                            Write-PscriboMessage -IsWarning "No Unlinked Group Policy Objects information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($OutObj) {
                            ...
                            Write-PscriboMessage -IsWarning "No Empty GPO information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($OutObj) {
                            ...
                            Write-PscriboMessage -IsWarning "No Enforced GPO information found, disabling section."
                        }
                    }
                    catch {
                    ...
                    try {
                        ...
                        if ($OrphanGPOs) {
                            ...
                            Write-PscriboMessage -IsWarning "No Orphaned GPO information found, disabling section."
                        }
                    }
                    catch {

                ...
                Section -Style Heading3 $reportTranslate.GetAbrADSite.Replication {
                    ...
                    if ($Options.EnableDiagrams) {
                        try {
                            try {
                                ...
                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorReplicationDiagramGraph) $($_.Exception.Message)"
                            }
                            ...
                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorReplicationDiagramSection) $($_.Exception.Message)"
                        }
                    }
                    Section -Style Heading4 $reportTranslate.GetAbrADSite.Sites {
                            ...
                            try {
                                ...
                                $inObj = [ordered] @{
                                    ...
                                    $reportTranslate.GetAbrADSite.DomainControllers = & {
                                        $ServerArray = [System.Collections.Generic.List[object]]::new()
                                ...
                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorDomainSite) $($_.Exception.Message)"
                            }
                        }
                        ...
                        if ($HealthCheck.Site.BestPractice) {
                            ...
                            if ($OutObj | Where-Object { $_.$($reportTranslate.GetAbrADSite.SubnetsCol) -eq $reportTranslate.GetAbrADSite.NoSubnetAssigned }) {
                                ...
                                $List.Add($reportTranslate.GetAbrADSite.SiteSubnetBP)
                            }
                            if ($OutObj | Where-Object { $_.$($reportTranslate.GetAbrADSite.DomainControllers) -eq $reportTranslate.GetAbrADSite.NoDCAssigned }) {
                                ...
                                $List.Add($reportTranslate.GetAbrADSite.SiteDCBP)
                            }
                        }
                    ...
                    try {
                        ...
                        if ($Replications) {
                            Section -ExcludeFromTOC -Style NOTOCHeading4 $reportTranslate.GetAbrADSite.ConnectionObjects {
                                ...
                                foreach ($Repl in $Replications) {
                                    try {
                                        ...
                                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSiteReplicationConnectionItem) $($_.Exception.Message)"
                                    }
                                }
                            ...
                            Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoConnectionObjectsInfo -f $ForestInfo)
                        }
                    } catch {
                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorConnectionObjects) $($_.Exception.Message)"
                    }
                    try {
                            ...
                            Section -Style Heading4 $reportTranslate.GetAbrADSite.SiteSubnets {
                                ...
                                foreach ($Item in $Subnet) {
                                    try {
                                        ...
                                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSiteSubnets) $($_.Exception.Message)"
                                    }
                                }
                                ...
                                if ($HealthCheck.Site.BestPractice) {
                                    ...
                                    if ($OutObj | Where-Object { $_.$($reportTranslate.GetAbrADSite.Sites) -eq $reportTranslate.GetAbrADSite.NoSiteAssigned }){
                                        ...
                                        $List.Add($reportTranslate.GetAbrADSite.SubnetSiteBP)
                                    }
                                }
                                ...
                                if ($HealthCheck.Site.BestPractice) {
                                    try {
                                            ...
                                            foreach ($DC in ($DomainInfo.ReplicaDirectoryServers | Where-Object { $_ -notin $Options.Exclude.DCs })) {
                                                if (Get-DCWinRMState -ComputerName $DC -DCStatus ([ref]$DCStatus)) {
                                                    try {
                                                        ...
                                                        if ($DCPssSession) {
                                                            $Path = "\\$DC\admin`$\debug\netlogon.log"
                                                            if ((Invoke-CommandWithTimeout -Session $DCPssSession -ScriptBlock { Test-Path -Path $using:path -PathType Leaf }) -and (Invoke-CommandWithTimeout -Session $DCPssSession -ScriptBlock { (Get-Content -Path $using:path | Measure-Object -Line).lines -gt 0 })) {
                                                                ...
                                                                Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.UnableToRead -f $Path, $DC)
                                                            }
                                                        } else {
                                                            if (-not $_.Exception.MessageId) {
                                                                $ErrorMessage = $_.FullyQualifiedErrorId
                                                            } else { $ErrorMessage = $_.Exception.MessageId }
                                                            Write-PScriboMessage -IsWarning -Message ($reportTranslate.GetAbrADSite.ErrorMissingSubnetPSSession -f $DC, $ErrorMessage)
                                                        }
                                                    } catch {
                                                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorMissingSubnetItemTable) $($_.Exception.Message)"
                                                    }
                                                }
                                            }
                                        }
                                        if ($OutObj) {
                                            ...
                                            Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoMissingSubnetsInfo -f $ForestInfo)
                                        }
                                    } catch {
                                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorMissingSubnetItemSection) $($_.Exception.Message)"
                                    }
                                }
                            }
                        } else {
                            Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSiteSubnetsInfo -f $ForestInfo)
                        }
                    } catch {
                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSiteSubnets) $($_.Exception.Message)"
                    }
                    if ($Options.EnableDiagrams) {
                        try {
                            try {
                                ...
                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSiteTopologyDiagramGraph) $($_.Exception.Message)"
                            }
                            ...
                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSiteTopologyDiagramSection) $($_.Exception.Message)"
                        }
                    }
                    try {
                        ...
                        $InterSiteTransports = try { Invoke-CommandWithTimeout -Session $TempPssSession -ErrorAction Stop -ScriptBlock { Get-ADObject -Filter { (objectClass -eq 'interSiteTransport') } -SearchBase "CN=Inter-Site Transports,CN=Sites,CN=Configuration,$using:DomainDN" -Properties * } } catch { $null }
                            ...
                            Section -Style Heading4 $reportTranslate.GetAbrADSite.InterSiteTransports {
                                ...
                                try {
                                    ...
                                    foreach ($Item in $InterSiteTransports) {
                                        $SiteArray = [System.Collections.Generic.List[object]]::new()
                                        switch ($Item.options) {
                                            $null {
                                    ...
                                    Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorInterSiteTransports) $($_.Exception.Message)"
                                }
                                try {
                                                ...
                                                Section -Style Heading5 $reportTranslate.GetAbrADSite.SiteLinks {
                                                    foreach ($Item in $IPLink) {
                                                        ...
                                                        try {
                                                            ...
                                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorIPSiteLinksTable) $($_.Exception.Message)"
                                                        }
                                                    }
                                                }
                                            } else {
                                                Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoIPSiteLinksInfo -f $ForestInfo)
                                            }
                                        } catch {
                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorIPSiteLinksSection) $($_.Exception.Message)"
                                        }
                                        try {
                                                ...
                                                Section -Style Heading5 $reportTranslate.GetAbrADSite.SiteLinkBridges {
                                                    foreach ($Item in $IPLinkBridges) {
                                                        ...
                                                        try {
                                                            ...
                                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorIPSiteLinksBridgesTable) $($_.Exception.Message)"
                                                        }
                                                    }
                                                }
                                            } else {
                                                Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoIPSiteLinksBridgesInfo -f $ForestInfo)
                                            }
                                        } catch {
                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorIPSiteLinksSection) $($_.Exception.Message)"
                                        }
                                    ...
                                    Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorIP) $($_.Exception.Message)"
                                }
                                try {
                                    ...
                                    if ($IPLink) {
                                                ...
                                                Section -Style Heading5 $reportTranslate.GetAbrADSite.SiteLinks {
                                                    foreach ($Item in $IPLink) {
                                                        ...
                                                        try {
                                                            ...
                                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSMTPSiteLinksTable) $($_.Exception.Message)"
                                                        }
                                                    }
                                                }
                                            } catch {
                                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSMTPSiteLinksSection) $($_.Exception.Message)"
                                            }
                                            try {
                                                    ...
                                                    Section -Style Heading5 $reportTranslate.GetAbrADSite.SiteLinkBridges {
                                                        foreach ($Item in $IPLinkBridges) {
                                                            ...
                                                            try {
                                                                ...
                                                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSMTPSiteLinksBridgesTable) $($_.Exception.Message)"
                                                            }
                                                        }
                                                    }
                                                } else {
                                                    Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSMTPSiteLinksBridgesInfo -f $ForestInfo)
                                                }
                                            } catch {
                                                Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSMTPSiteLinksSection) $($_.Exception.Message)"
                                            }
                                        ...
                                        Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSMTPSiteLinksInfo -f $ForestInfo)
                                    }
                                } catch {
                                    Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSMTP) $($_.Exception.Message)"
                                }
                            }
                        } else {
                            Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSMTPSiteLinksInfo -f $ForestInfo)
                    ...
                    try {
                                ...
                                if (Get-DCWinRMState -ComputerName $DC -DCStatus ([ref]$DCStatus)) {
                                    ...
                                    if ($DCCIMSession) {
                                        ...
                                        try {
                                            ...
                                            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSysvolReplicationItemSection) $($_.Exception.Message)"
                                        }
                                    ...
                                    try {
                                        Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.UnableToCollect -f $DC)
                                        $inObj = [ordered] @{
                                            $reportTranslate.GetAbrADSite.DCName = $DC.split('.', 2)[0]
                                        ...
                                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorDNSIPConfigItem) $($_.Exception.Message)"
                                    }
                                }
                            }
                        }
                        if ($OutObj) {
                            ...
                            Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSysvolReplicationInfo -f $ForestInfo)
                        }
                    } catch {
                        Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorSysvolReplicationTableSection) $($_.Exception.Message)"
                    }
                }
            } else {
                Write-PScriboMessage -Message ($reportTranslate.GetAbrADSite.NoSitesInfo -f $ForestInfo)
            }
        } catch {
            Write-PScriboMessage -IsWarning -Message "$($reportTranslate.GetAbrADSite.ErrorDomainSiteGlobal) $($_.Exception.Message)"
        }
    }

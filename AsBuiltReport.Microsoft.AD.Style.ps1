...
if ($ReportConfig.Report.ShowCoverPageImage) {
    Try {
        ...
        Write-PScriboMessage -IsWarning -Message "Unable to display cover page image. Please set 'ShowCoverPageImage' to 'false' in the report JSON configuration file to avoid this error."
    }
}
